...
//               height: 20,
//             ),
//             if (!widget.orderdata['is_delivered'])
//               GestureDetector(
//                 onTap: () {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: <Widget>[
            ...
            Text(
              "Total Amount: ${widget.order.totalAmount.toStringAsFixed(2)} INR",
              style: TextStyle(
                color: Colors.black,
                fontSize: 20,
                fontFamily: 'MuseoModerno',
            ...
            Text(
              "Status: ${widget.order.status ? "Delivered" : "Pending"}",
              style: TextStyle(
                color: Colors.black,
                fontSize: 20,
                fontFamily: 'MuseoModerno',
            ...
            if (!widget.order.status)
              GestureDetector(
                onTap: () {
                  orderReceived(widget.order.orderId, context);
                },
                child: CustomRaisedButton(buttonText: 'Received'),
              ),
          ],
