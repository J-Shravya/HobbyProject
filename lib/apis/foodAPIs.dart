...
login(
    app_user.User user, AuthNotifier authNotifier, BuildContext context) async {
...
getUserDetails(AuthNotifier authNotifier) async {
  await FirebaseFirestore.instance
      ...
      .then((value) => {
            (value != null)
                ? authNotifier
                    .setUserDetails(app_user.User.fromMap(value.data()))
                : print(value)
          });
}

uploadUserData(app_user.User user, bool userdataUpload) async {
